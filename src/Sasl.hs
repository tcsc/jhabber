...
{-| Possible states of a digest AuthInfo block. -}
...
{-| An ADT representing the various forms of authentication supported by the
    server. -}
data AuthInfo = None
              | Basic String
...
hashL = BS.concat . LazyBS.toChunks . runPut . put . md5
